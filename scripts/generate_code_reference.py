...
FILE_DESCRIPTIONS = {
    ...
    "docs/ui/screenshots/01-home-desktop.png": "Реальный desktop-снимок начального состояния работающего UI.",
    "docs/ui/screenshots/02-loading-desktop.png": "Реальный desktop-снимок состояния выполнения Search-запроса.",
    "docs/ui/screenshots/03-search-results-desktop.png": "Реальный desktop-снимок пяти результатов векторного поиска.",
    "docs/ui/screenshots/04-ask-answer-desktop.png": "Реальный desktop-снимок Ask-ответа локальной Ollama и источников.",
    "docs/ui/screenshots/05-validation-error-desktop.png": "Реальный desktop-снимок ошибки формы без API-ключа.",
    "docs/ui/screenshots/06-search-results-mobile.png": "Реальный mobile-снимок результатов Search при ширине 390 px.",
    "docs/ui/screenshots/07-ask-answer-mobile.png": "Реальный mobile-снимок Ask-ответа и источников при ширине 390 px.",
    "docs/ui/screenshots/08-home-mobile.png": "Реальный mobile-снимок начального responsive-состояния UI.",
