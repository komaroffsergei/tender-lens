...
Подготовлено 07.09.2026, режим MWS подключён 09.09.2026. Четыре собственных синтетических HTML-документа: серверы, резервное копирование, Angular-портал, мониторинг сети. Реальных заказчиков и закупок нет. Внешний crawler отключён. Embeddings bge-m3 и grounded-ответ gpt-oss-120b выполняются реальными деплойментами MWS Model Hub.
